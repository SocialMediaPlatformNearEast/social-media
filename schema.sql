...
CREATE TABLE IF NOT EXISTS users (
  ...
  last_xp_reward_date DATE NULL,
  badge_color CHAR(7) NOT NULL DEFAULT '#71767B',
  activity_title VARCHAR(40) NOT NULL DEFAULT 'New User',
...
ALTER TABLE users ADD COLUMN IF NOT EXISTS total_xp INT UNSIGNED NOT NULL DEFAULT 0 AFTER avatar_color;
ALTER TABLE users ADD COLUMN IF NOT EXISTS level INT UNSIGNED NOT NULL DEFAULT 1 AFTER total_xp;
ALTER TABLE users ADD COLUMN IF NOT EXISTS xp_today INT UNSIGNED NOT NULL DEFAULT 0 AFTER level;
ALTER TABLE users ADD COLUMN IF NOT EXISTS last_xp_reward_date DATE NULL AFTER xp_today;
ALTER TABLE users ADD COLUMN IF NOT EXISTS badge_color CHAR(7) NOT NULL DEFAULT '#71767B' AFTER last_xp_reward_date;
ALTER TABLE users ADD COLUMN IF NOT EXISTS activity_title VARCHAR(40) NOT NULL DEFAULT 'New User' AFTER badge_color;
ALTER TABLE users ADD COLUMN IF NOT EXISTS profile_completed_at TIMESTAMP NULL AFTER activity_title;
