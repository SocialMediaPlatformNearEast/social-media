...
- Made Search more useful with Latest ordering, username matching, discovery users, and recent posts.
...
- Added CSRF protection to active POST forms.
- Rebuilt the Messages sidebar from real message history instead of a placeholder user list.
- Moved stale PHP/root files and duplicate static files into `legacy/` archives.
...
- Add nav badges for unread notifications and messages.
